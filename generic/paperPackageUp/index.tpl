 ...
 *}
{strip}
{assign var="pageTitle" value="plugins.generic.paperPackageUpload.displayName"}
...
<!--	<h3>{translate key="plugins.generic.paperPackageUpload.chooseDestination"}</h3>
	...
	<table class="data" width="100%">
		<tr valign="top">
			...
			<td colspan="2" class="value" width="95%">{fieldLabel name="destinationUnpublished" key="plugins.generic.paperPackageUpload.leaveUnpublished"}</td>
		</tr>
		<tr valign="top">
			...
			<td width="20%" class="value">
				{fieldLabel name="destinationIssue" key="plugins.generic.paperPackageUpload.addToExisting"}
			</td>
			<td class="value">
...
<!--		<tr valign="top">
       ...
       <div id="submissionHandle">
              ...
              <tr valign="top">
                      <td width="30%" class="label">{fieldLabel name="submissionHandle" key="plugins.generic.paperPackageUpload.submissionHandle"}</td>
	...
	<div id="addSubmissionFile">
		...
		<tr>
			<td width="30%" class="label">
				...
				{else}
					{fieldLabel name="submissionFile" key="plugins.generic.paperPackageUpload.uploadSubmissionFile"}
				{/if}
			</td>
	...
	<div id="supplementaryFile">
	    <h4>{fieldLabel required="true" key="plugins.generic.paperPackageUpload.suppFile"}</h4>
		<table class="data" width="100%">
	...
	<!--	<tr valign="top">
        ...
        <div id="supplHandle">
                <table width="100%" class="data">
                 ...
                 <tr valign="top">
                        <td width="30%" class="label">{fieldLabel name="supplHandle" key="plugins.generic.paperPackageUpload.supplHandle"}</td>
	...
	<div id="addSupplFile">
		...
		<tr>
			<td width="30%" class="label">
				{if $supplementaryFile}
					{fieldLabel name="supplementaryFile" key="plugins.generic.paperPackageUpload.replaceSuppFile"}
				{else}
					{fieldLabel name="supplementaryFile" key="plugins.generic.paperPackageUpload.uploadSuppFile"}
				{/if}
			</td>
			<td width="70%" class="value">
	...
	<div id="titleAndAbstract">
		<h4>{translate key="plugins.generic.paperPackageUpload.titleAndAbstract"}</h4>
