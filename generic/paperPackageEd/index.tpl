 ...
 *}
{strip}
{assign var="pageTitle" value="plugins.generic.paperPackageEdit.displayName"}
...
<p>{translate key="plugins.generic.paperPackageEdit.descriptionLong"}</p>
...
<!--	<h3>{translate key="plugins.generic.paperPackageEdit.chooseDestination"}</h3>

	<p>{translate key="plugins.generic.paperPackageEdit.chooseDestinationDescription"}</p>
	...
	<table class="data" width="100%">
		<tr valign="top">
			...
			<td colspan="2" class="value" width="95%">{fieldLabel name="destinationUnpublished" key="plugins.generic.paperPackageEdit.leaveUnpublished"}</td>
		</tr>
		<tr valign="top">
			...
			<td width="20%" class="value">
				{fieldLabel name="destinationIssue" key="plugins.generic.paperPackageEdit.addToExisting"}
			</td>
			<td class="value">
...
<!--		        <td width="30%" class="label">{translate key="plugins.generic.paperPackageEdit.revertToLastFile"} <a href="{plugin_url}">{$pastSubmissionFile->getOriginalFileName()|escape}</a></td> -->
		</tr>
		{else}
		<tr valign="top">
                        <td width="30%" class="label">{translate key="common.originalFileName"}</td>
                ...
                <tr valign="top">
                        <td width="30%" class="label">{translate key="common.dateUploaded"}</td>
                        <td width="70%" class="value">{$submissionFile->getDateUploaded()|date_format:$datetimeFormatShort}</td>
		<!--	<td colspan="2" class="nodata">{translate key="plugins.generic.paperPackageEdit.submissionHandleDescription"}</td> -->
		</tr>
		{/if}
		</table>
	</div> <!-- /submissionFile -->
       ...
       <div id="submissionHandle">
              ...
              <tr valign="top">
                      <td width="30%" class="label">{fieldLabel name="submissionHandle" key="plugins.generic.paperPackageEdit.submissionHandle"}</td>
	...
	<div id="addSubmissionFile">
		...
		<tr>
			<td width="30%" class="label">
				...
				{else}
					{fieldLabel name="submissionFile" key="plugins.generic.paperPackageEdit.uploadSubmissionFile"}
				{/if}
			</td>
			<td width="70%" class="value">
	...
	<div id="supplementaryFile">
	    <h4>{fieldLabel required="true" key="plugins.generic.paperPackageEdit.suppFile"}</h4>
		<table class="data" width="100%">
		...
		<tr valign="top">
                        <td width="30%" class="label">{translate key="common.dateUploaded"}</td>
                        <td width="70%" class="value">{$supplementaryFile->getDateUploaded()|date_format:$datetimeFormatShort}</td>
		<!--	<td colspan="2" class="nodata">{translate key="plugins.generic.paperPackageEdit.supplHandleDescription"}</td>-->
		</tr>
		{/if}
		</table>
        ...
        <div id="supplHandle">
                <table width="100%" class="data">
                 ...
                 <tr valign="top">
                        <td width="30%" class="label">{fieldLabel name="supplHandle" key="plugins.generic.paperPackageEdit.supplHandle"}</td>
		...
		<tr>
			<td width="30%" class="label">
				{if $supplementaryFile}
					{fieldLabel name="supplementaryFile" key="plugins.generic.paperPackageEdit.replaceSuppFile"}
				{else}
					{fieldLabel name="supplementaryFile" key="plugins.generic.paperPackageEdit.uploadSuppFile"}
				{/if}
			</td>
			<td width="70%" class="value">
	...
	<div id="titleAndAbstract">
		<h4>{translate key="plugins.generic.paperPackageEdit.titleAndAbstract"}</h4>
		...
		<tr valign="top">
			...
			<tr valign="top">
			<td width="30%" class="label">{fieldLabel name="originalJournal" required="true" key="plugins.generic.paperPackageEdit.originalJournal"}</td>
