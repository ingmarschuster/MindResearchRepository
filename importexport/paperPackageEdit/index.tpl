 ...
 *}
{strip}
{assign var="pageTitle" value="plugins.importexport.paperPackageEdit.displayName"}
{include file="common/header.tpl"}
{/strip}

{if $userIsNotEditor}
<p>{translate key="plugins.importexport.paperPackageEdit.accessDeniedDescription"}</p>
{else}
{literal}
...
<p>{translate key="plugins.importexport.paperPackageEdit.descriptionLong"}</p>
...
<table width="100%" class="data">
	<tr valign="top">
		...
		<td width="80%" class="value">
			{plugin_url|assign:"paperPackageEditUrl" escape=false}
			...
			{foreach from=$authors key=authorIndex item=author}
				...
				{/foreach}
			{/foreach}
			{form_language_chooser form="submit" url=$paperPackageEditUrl}
...
<!--	<h3>{translate key="plugins.importexport.paperPackageEdit.chooseDestination"}</h3>

	<p>{translate key="plugins.importexport.paperPackageEdit.chooseDestinationDescription"}</p>
	...
	<table class="data" width="100%">
		<tr valign="top">
			...
			<td colspan="2" class="value" width="95%">{fieldLabel name="destinationUnpublished" key="plugins.importexport.paperPackageEdit.leaveUnpublished"}</td>
		</tr>
		<tr valign="top">
			...
			<td width="20%" class="value">
				{fieldLabel name="destinationIssue" key="plugins.importexport.paperPackageEdit.addToExisting"}
			</td>
			<td class="value">
		...
		<tr valign="top">
			<td class="label">{fieldLabel name="datePublished" required="true" key="plugins.importexport.paperPackageEdit.datePublished"}</td>
			<td class="value">
...
<h3>{translate key="plugins.importexport.paperPackageEdit.submissionData"}</h3>
...
<div id="submission" style="margin: 0 10px 0 10px;">
	...
	<div id="submissionFile">
            <h4>{fieldLabel required="true" key="plugins.importexport.paperPackageEdit.submissionFile"}</h4>
		<table class="data" width="100%">
		...
		<tr valign="top">
		        <td width="30%" class="label">{translate key="plugins.importexport.paperPackageEdit.nix"}</td>
			<td width="70%" class="value">{translate key="plugins.importexport.paperPackageEdit.nix"} <input name="uploadSubmissionFile" type="submit" class="button" value="{translate key="plugins.importexport.paperPackageEdit.revertToLastFile"}" /></td>
		</tr>
		<tr valign="top">
...
<!--		        <td width="30%" class="label">{translate key="plugins.importexport.paperPackageEdit.revertToLastFile"} <a href="{plugin_url}">{$pastSubmissionFile->getOriginalFileName()|escape}</a></td> -->
		</tr>
		{else}
		<tr valign="top">
                        <td width="30%" class="label">{translate key="common.originalFileName"}</td>
                ...
                <tr valign="top">
                        <td width="30%" class="label">{translate key="common.dateUploaded"}</td>
                        <td width="70%" class="value">{$submissionFile->getDateUploaded()|date_format:$datetimeFormatShort}</td>
		<!--	<td colspan="2" class="nodata">{translate key="plugins.importexport.paperPackageEdit.submissionHandleDescription"}</td> -->
		</tr>
		{/if}
		</table>
	</div> <!-- /submissionFile -->
       ...
       <div id="submissionHandle">
              ...
              <tr valign="top">
                      <td width="30%" class="label">{fieldLabel name="submissionHandle" key="plugins.importexport.paperPackageEdit.submissionHandle"}</td>
	...
	<div id="addSubmissionFile">
		...
		<tr>
			<td width="30%" class="label">
				...
				{else}
					{fieldLabel name="submissionFile" key="plugins.importexport.paperPackageEdit.uploadSubmissionFile"}
				{/if}
			</td>
			<td width="70%" class="value">
				<input type="file" class="uploadField" name="submissionFile" id="submissionFileUpload" /> <input name="uploadSubmissionFile" type="submit" class="button" value="{translate key="plugins.importexport.paperPackageEdit.replace"}" />
			</td>
		</tr>
		</table>
	...
	<div id="supplementaryFile">
	    <h4>{fieldLabel required="true" key="plugins.importexport.paperPackageEdit.suppFile"}</h4>
		<table class="data" width="100%">
		{if $supplementaryFile != $pastSupplementaryFile}
		<tr valign="top">
			<td width="30%" class="label">{translate key="common.originalFileName"}</td>
		...
		<tr valign="top">
                        <td width="30%" class="label">{translate key="plugins.importexport.paperPackageEdit.nix"}</td>
                        <td width="70%" class="value">{translate key="plugins.importexport.paperPackageEdit.nix"} <input name="uploadSupplementaryFile" type="submit" class="button" value="{translate key="plugins.importexport.paperPackageEdit.revertToLastFile"}" /></td>
                </tr>
		<tr valign="top">
			<td width="30%" class="label">{translate key="common.fileSize"}</td>
		...
		<tr valign="top">
                        <td width="30%" class="label">{translate key="common.dateUploaded"}</td>
                        <td width="70%" class="value">{$supplementaryFile->getDateUploaded()|date_format:$datetimeFormatShort}</td>
		<!--	<td colspan="2" class="nodata">{translate key="plugins.importexport.paperPackageEdit.supplHandleDescription"}</td>-->
		</tr>
		{/if}
		</table>
        ...
        <div id="supplHandle">
                <table width="100%" class="data">
                 ...
                 <tr valign="top">
                        <td width="30%" class="label">{fieldLabel name="supplHandle" key="plugins.importexport.paperPackageEdit.supplHandle"}</td>
		...
		<tr>
			<td width="30%" class="label">
				{if $supplementaryFile}
					{fieldLabel name="supplementaryFile" key="plugins.importexport.paperPackageEdit.replaceSuppFile"}
				{else}
					{fieldLabel name="supplementaryFile" key="plugins.importexport.paperPackageEdit.uploadSuppFile"}
				{/if}
			</td>
			<td width="70%" class="value">
				<input type="file" class="uploadField" name="supplementaryFile" id="supplementaryFileUpload" /> <input name="uploadSupplementaryFile" type="submit" class="button" value="{translate key="plugins.importexport.paperPackageEdit.replace"}" />
			</td>
		</tr>
		</table>
	</div>  <!-- /addSupplFile -->
	...
	<div id="titleAndAbstract">
		<h4>{translate key="plugins.importexport.paperPackageEdit.titleAndAbstract"}</h4>
		...
		<tr valign="top">
			...
			<tr valign="top">
			<td width="30%" class="label">{fieldLabel name="originalJournal" required="true" key="plugins.importexport.paperPackageEdit.originalJournal"}</td>
			<td width="70%" class="value"><input type="text" class="textField" name="originalJournal" id="originalJournal" value="{$originalJournal}" size="60" maxlength="255" /></td> 
...
<input type="submit" class="button" name="createAnother" value="{translate key="plugins.importexport.paperPackageEdit.saveAndCreateAnother"}" />    
